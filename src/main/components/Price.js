                    ...
                    <div className="row">
                        <div className="price-responsive p-4 mt-md-0">
                            <div className="box featured" data-aos="zoom-in" data-aos-delay="50">
                                ...
                                <span className="nft-unit">0 ~ 500</span><br />
                                <h4><sup>$</sup>0<span>FTM</span></h4>
                            </div>
                        </div>
                        <div className="price-responsive p-4 mt-md-0">
                            <div className="box featured" data-aos="zoom-in" data-aos-delay="50">
                                <h3>STAGE<span className="number"> 2</span></h3>
                                <span className="nft-unit">500 ~ 2000</span><br />
                                <h4><sup>$</sup>30<span>FTM</span></h4>
                            </div>
                        </div>
                        ...
                        <div className="price-responsive p-4 mt-md-0">
                            <div className="box featured" data-aos="zoom-in" data-aos-delay="50">
                                ...
                                <h4><sup>$</sup>50<span>FTM</span></h4>
                            </div>
                        </div>
                        ...
                        <div className="price-responsive p-4 mt-md-0">
                            <div className="box featured" data-aos="zoom-in" data-aos-delay="50">
                                ...
                                <h4><sup>$</sup>70<span>FTM</span></h4>
                            </div>
                        </div>
                        ...
                        <div className="price-responsive p-4 mt-md-0">
                            <div className="box featured" data-aos="zoom-in" data-aos-delay="50">
                                ...
                                <h4><sup>$</sup>90<span>FTM</span></h4>
                            </div>
                        </div>

                        <div className="price-responsive p-4 mt-md-0">
                            <div className="box featured" data-aos="zoom-in" data-aos-delay="50">
                                <h3>STAGE<span className="number"> 6</span></h3>
                                <span className="nft-unit">8000 ~ 10000</span><br />
                                <h4><sup>$</sup>110<span>FTM</span></h4>
                            </div>
                        </div>
